...
type Props = {
  handleSubmit?: (data: z.infer<typeof CourseDataSchema>) => void;
  submitButtonLabel: React.ReactNode;
};

export default function CourseForm({ handleSubmit, submitButtonLabel }: Props) {
    ...
    >
      ...
      <div className="mb-6 pb-4 border-b border-gray-200">
        ...
        <p className="text-sm text-gray-600">
          أضف المعلومات الأساسية لدورتك التدريبية
        </p>
      </div>
        ...
        <form onSubmit={form.handleSubmit(handleSubmit || (() => {}))}>
          ...
          <div className="mt-6 flex gap-3  pt-4 border-t border-gray-200">
            <Button
              ...
              type="submit"
              className="px-6 py-2 h-10 hover:bg-gray-50 transition-colors mx-auto block"
              disabled={form.formState.isSubmitting}
            >
              {submitButtonLabel}
            </Button>

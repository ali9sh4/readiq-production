  ...
  useEffect(() => {
    ...
    const errorMap: Record<string, { title: string; details: string }> = {
      ...
      topup_failed: {
        title: "فشل الدفع",
        details:
          "لم تكتمل عملية الدفع عبر زين كاش. لم يتم شحن محفظتك. يمكنك المحاولة مرة أخرى.",
      },
      topup_not_found: {
        title: "طلب الشحن غير موجود",
        details:
          "لم نتمكن من العثور على عملية الشحن. إذا تم خصم المبلغ، يرجى التواصل مع الدعم.",
      },
      payment_cancelled: {
